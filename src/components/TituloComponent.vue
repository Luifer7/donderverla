    ...
    <div class="px-3 text-center" >
        ...
        <div class="row" >
            ...
            <div style="height: 320px;" class="col-6 col-4 col-md-3 col-lg-2 p-2" 
                 v-for="p of titulos" :key="p.id" @click="detalles(p)" >

                 <div class="h-100 w-100 rounded box-pelicula">

                    <!-- POR SI PELICULA Y SERIE-->
                    ...
                    <!-- POR SI PELICULA -->
                    <div v-if="p.title" style="height:40px;" 
                    ...
                    <!-- POR SI SERIE -->
                    <div v-if="p.name" style="height:40px;" 
                    class="m-0 text-white d-flex align-items-center justify-content-center"> 
...
defineProps({
    titulos: Object, resultados: Object, peticion: String
})
...
const detalles = (p) => {
    ...
    if (p.title) {
        router.push( { name: 'titulo', params: { modo: route.params.modo, titulo: p.title, id: p.id } } )      
    }
    if (p.name) {
        router.push( { name: 'titulo', params: { modo: route.params.modo, titulo: p.name, id: p.id } } )      
    }
